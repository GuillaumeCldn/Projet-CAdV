...
\begin{document}
	...
	La validation sur le modèle non-linéaire (sur une durée de \SI{60}{s}) démontre le bon fonctionnement de la loi. On observe sur la figure~\ref{fig:resultat_vitesse} que le système non linéaire répond de façon adéquate à un échelon de consigne d'amplitude \SI{2}{kts}.

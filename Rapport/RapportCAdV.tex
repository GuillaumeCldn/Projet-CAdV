...
Nous avons retenu une structure de commande classique de type PI-D (Proportionnel Intégral, Dérivée sur la mesure) associée à un pré-filtre sur la consigne. Les gains ont été calculés via la méthode de Wang, présentée dans le sujet au paragraphe 3.5.1 du sujet \cite{Sujet} et dans l'article de \emph{Wang et al.} \cite{Wang2009}.
	...
	\begin{figure}[H]
		\centering
		%\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{reponse_lineaire_modale_prefiltre.png}}
		\caption{Réponse de la commande modale à une consigne en échelon}
	...
	La simulation de la commande modale donne les résultats suivants:
	\begin{figure}[H]
		\centering
		\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{reponse_lineaire_modale_integrateur.png}}
